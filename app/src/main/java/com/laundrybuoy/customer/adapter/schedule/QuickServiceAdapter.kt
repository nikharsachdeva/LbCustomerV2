...
class QuickServiceAdapter(val listener: OnServiceSelect) :
    ListAdapter<ServiceModel.Data, QuickServiceAdapter.AddressViewHolder>(
        ComparatorDiffUtil()
    ) {
    ...
    inner class AddressViewHolder(private val binding: RowItemSelectServiceBinding) :
        ...
        fun bind(service: ServiceModel.Data, position: Int) {
            ...
            binding.serviceRootRl.setOnClickListener {
                ...
                listener.serviceSelected(service)
            }

        }
    }

    interface OnServiceSelect {
        fun serviceSelected(service: ServiceModel.Data)
    }
